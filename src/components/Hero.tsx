      ...
      <section>
        <div className='px-8 py-12'>
          <div className='flex flex-col md:flex-row'>
            <div className='w-full md:w-[60%] h-auto md:h-[580px] border border-black bg-[#2A254B]  text-white px-12 md:px-12 py-6 md:py-12 flex flex-col justify-between'>
              <div>
            ...
            <div className='w-[520px] h-[584px] md:w-[40%]  md:h-[580px] bg-white mr-[520px] flex justify-center items-end'>
              <Image src={'/nazim.png'} width={520} height={584} alt='right' />
            </div>
          </div>
        </div>
      </section>
